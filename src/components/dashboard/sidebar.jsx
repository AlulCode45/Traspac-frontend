...
function Sidebar(props) {
    ...
    return (<aside className={'p-4 w-1/5 bg-white h-screen rounded-br-3xl rounded-tr-3xl'}>
            ...
            <div className="flex flex-col gap-2">
                <span>Menu</span>
                <div className="link-menu p-3 flex items-center gap-3 bg-blue-500 rounded-md text-white relative">
                    <div
                        className={`${activeTab === 0 ? 'bg-blue-500' : ''} absolute rounded-md -left-5 w-[10px] h-full`}></div>
                    <MdDashboard/> Dashboard
                </div>
                <div
                    className="link-menu p-3 flex items-center gap-3 rounded-md text-black hover:bg-blue-500 hover:text-white transition duration-200 relative">
                    <div
